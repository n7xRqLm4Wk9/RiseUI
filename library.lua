...
local Library = {
    ...
    Lucide = {
        ...
        Combat = "rbxassetid://13054172036",
        Movement = "rbxassetid://13054165689",
        Player = "rbxassetid://13054181008",
        Render = "rbxassetid://13054173361",
        Exploit = "rbxassetid://13054170669",
        Ghost = "rbxassetid://13054174351",
        Other = "rbxassetid://13054176466",
        Script = "rbxassetid://13054178553",
        Themes = "rbxassetid://13054179374",
        Language = "rbxassetid://13054175780",
        Settings = "rbxassetid://13054182436",
...
function Library:CreateWindow(Options)
    ...
    local function ProcessNotifications()
        ...
        Create("UIStroke", { Parent = Frame, Color = Library.Theme.Stroke, Thickness = 1, ApplyStrokeMode = Enum.ApplyStrokeMode.Border })
        ...
        Tween(Frame, {BackgroundTransparency = 0, Position = UDim2.new(0, 0, 0, 0)}, 0.25)
        Tween(Title, {TextTransparency = 0}, 0.2)
        Tween(Content, {TextTransparency = 0}, 0.2)
        
        task.delay(duration, function()
            if not Frame.Parent then return end
            Tween(Frame, {BackgroundTransparency = 1, Position = UDim2.new(1, 300, 0, 0)}, 0.2)
    ...
    function Window:MakeTab(TabOptions)
        ...
        function Tab:MakeModule(ModOptions)
            ...
            -- ==========================================
            -- MODULE INTERNAL SETTINGS (Sliders, Dropdowns, Toggles)
            -- ==========================================
